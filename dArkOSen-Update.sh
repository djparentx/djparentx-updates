...
if [ ! -f "/home/ark/.config/.dArkOSen-update07042026" ]; then
	...
	sudo rm -rf /dev/shm/*
	sudo wget -t 3 -T 60 --no-check-certificate "$LOCATION"/07042026/dArkOSen-update07042026.zip -O /dev/shm/dArkOSen-update07042026.zip -a "$LOG_FILE" || sudo rm -f /dev/shm/dArkOSen-update07042026.zip | tee -a "$LOG_FILE"
